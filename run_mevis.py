...
def parse_args():
    parser = argparse.ArgumentParser(description="Run evaluation on MeViS dataset with FindTrack-Refine")
...
def test(args):
    ...
    if not os.path.exists(meta_file):
        meta_file = os.path.join(root, 'valid', 'valid', 'meta_expressions.json')
